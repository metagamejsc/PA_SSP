...
if ( TRACE ) { TRACE( "GameController#AddMonster", this ); }
                ...
                if (this.monsters == null) {
                    this.monsters = new (System.Collections.Generic.List$1(MonsterController)).ctor();
                }
                this.monsters.add(m);
            },
...
if ( TRACE ) { TRACE( "LunaController#Start", this ); }
                ...
                this.setup.SetupMonster(this.RedLeft, this.UseHuman);
...
if ( TRACE ) { TRACE( "MonsterController#Dead", this ); }
    ...
    Bridge.define("SetupGame", {
        ...
        methods: {
            /*SetupGame.SetupMonster start.*/
            SetupMonster: function (redLeft, useHuman) {
if ( TRACE ) { TRACE( "SetupGame#SetupMonster", this ); }

                if (redLeft) {
                    GameController.Ins.AddMonster(this.red1);
                    GameController.Ins.AddMonster(this.red2);

                    this.red1.gameObject.SetActive(true);
                    this.red2.gameObject.SetActive(true);
                    this.red3_1.gameObject.SetActive(true);
                    this.red3_2.gameObject.SetActive(true);

                } else {
                    GameController.Ins.AddMonster(this.orange1);
                    GameController.Ins.AddMonster(this.orange2);

                    this.orange1.gameObject.SetActive(true);
                    this.orange2.gameObject.SetActive(true);
                    this.orange3_1.gameObject.SetActive(true);
                    this.orange3_2.gameObject.SetActive(true);
                }
                if (useHuman) {
                    this.target.AddTarget(this.human1);
                    this.target.AddTarget(this.human2);

                    this.human1.transform.parent.gameObject.SetActive(true);
                    this.human2.transform.parent.gameObject.SetActive(true);
                    this.human3.SetActive(true);
                } else {
                    if (redLeft) {
                        this.target.AddTarget(this.orange1_0);
                        this.target.AddTarget(this.orange2_0);

                        this.orange1_0.transform.parent.gameObject.SetActive(true);
                        this.orange2_0.transform.parent.gameObject.SetActive(true);
                        this.orange3_0.SetActive(true);
                    } else {
                        this.target.AddTarget(this.red1_0);
                        this.target.AddTarget(this.red2_0);

                        this.red1_0.transform.parent.gameObject.SetActive(true);
                        this.red2_0.transform.parent.gameObject.SetActive(true);
                        this.red3_0.SetActive(true);
                    }
                }
            },
            /*SetupGame.SetupMonster end.*/
    ...
    Bridge.define("TargetController", {
        ...
        methods: {
            /*TargetController.AddTarget start.*/
            AddTarget: function (t) {
if ( TRACE ) { TRACE( "TargetController#AddTarget", this ); }

                if (this.listTarget == null) {
                    this.listTarget = new (System.Collections.Generic.List$1(UnityEngine.TargetJoint2D)).ctor();
                }
                this.listTarget.add(t);
                this.currentTarget = this.listTarget.getItem(0);
            },
            /*TargetController.AddTarget end.*/
...
if ( TRACE ) { TRACE( "VFXController#ReturnToPool", this ); }
    ...
    /*SetupGame start.*/
    $m("SetupGame", function () { return {"att":1048577,"a":2,"m":[{"a":2,"isSynthetic":true,"n":".ctor","t":1,"sn":"ctor"},{"a":2,"n":"SetupMonster","t":8,"pi":[{"n":"redLeft","pt":$n[0].Boolean,"ps":0},{"n":"useHuman","pt":$n[0].Boolean,"ps":1}],"sn":"SetupMonster","rt":$n[0].Void,"p":[$n[0].Boolean,$n[0].Boolean]},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"human1","t":4,"rt":$n[1].TargetJoint2D,"sn":"human1"},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"human2","t":4,"rt":$n[1].TargetJoint2D,"sn":"human2"},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"human3","t":4,"rt":$n[1].GameObject,"sn":"human3"},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"orange1","t":4,"rt":MonsterController,"sn":"orange1"},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"orange1_0","t":4,"rt":$n[1].TargetJoint2D,"sn":"orange1_0"},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"orange2","t":4,"rt":MonsterController,"sn":"orange2"},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"orange2_0","t":4,"rt":$n[1].TargetJoint2D,"sn":"orange2_0"},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"orange3_0","t":4,"rt":$n[1].GameObject,"sn":"orange3_0"},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"orange3_1","t":4,"rt":MonsterController,"sn":"orange3_1"},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"orange3_2","t":4,"rt":MonsterController,"sn":"orange3_2"},{"at":[new UnityEngine.HeaderAttribute("Phase 1"),new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"red1","t":4,"rt":MonsterController,"sn":"red1"},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"red1_0","t":4,"rt":$n[1].TargetJoint2D,"sn":"red1_0"},{"at":[new UnityEngine.HeaderAttribute("Phase 2"),new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"red2","t":4,"rt":MonsterController,"sn":"red2"},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"red2_0","t":4,"rt":$n[1].TargetJoint2D,"sn":"red2_0"},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"red3_0","t":4,"rt":$n[1].GameObject,"sn":"red3_0"},{"at":[new UnityEngine.HeaderAttribute("Phase 3"),new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"red3_1","t":4,"rt":MonsterController,"sn":"red3_1"},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"red3_2","t":4,"rt":MonsterController,"sn":"red3_2"},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"target","t":4,"rt":TargetController,"sn":"target"}]}; }, $n);
    /*SetupGame end.*/

    /*TargetController start.*/
    $m("TargetController", function () { return {"att":1048577,"a":2,"m":[{"a":2,"isSynthetic":true,"n":".ctor","t":1,"sn":"ctor"},{"a":2,"n":"AddTarget","t":8,"pi":[{"n":"t","pt":$n[1].TargetJoint2D,"ps":0}],"sn":"AddTarget","rt":$n[0].Void,"p":[$n[1].TargetJoint2D]},{"a":1,"n":"CheckInput","t":8,"sn":"CheckInput","rt":$n[0].Void},{"a":2,"n":"IsEmpty","t":8,"sn":"IsEmpty","rt":$n[0].Boolean,"box":function ($v) { return Bridge.box($v, System.Boolean, System.Boolean.toString);}},{"a":2,"n":"NextTarget","t":8,"sn":"NextTarget","rt":$n[0].Void},{"a":2,"n":"RemoveTarget","t":8,"sn":"RemoveTarget","rt":$n[0].Void},{"a":1,"n":"RemoveTargetPoint","t":8,"sn":"RemoveTargetPoint","rt":$n[0].Void},{"a":1,"n":"SetTargetPoint","t":8,"pi":[{"n":"point","pt":$n[1].Vector2,"ps":0}],"sn":"SetTargetPoint","rt":$n[0].Void,"p":[$n[1].Vector2]},{"a":1,"n":"Update","t":8,"sn":"Update","rt":$n[0].Void},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"currentTarget","t":4,"rt":$n[1].TargetJoint2D,"sn":"currentTarget"},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"index","t":4,"rt":$n[0].Int32,"sn":"index","box":function ($v) { return Bridge.box($v, System.Int32);}},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"listTarget","t":4,"rt":$n[2].List$1(UnityEngine.TargetJoint2D),"sn":"listTarget"},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"tut","t":4,"rt":$n[1].GameObject,"sn":"tut"}]}; }, $n);
    /*TargetController end.*/
