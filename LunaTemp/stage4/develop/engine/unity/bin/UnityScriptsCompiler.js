...
if ( TRACE ) { TRACE( "BalanceController#Update", this ); }
    ...
    Bridge.define("BodyPiece", {
        ...
        methods: {
            /*BodyPiece.OnCollisionEnter2D start.*/
            OnCollisionEnter2D: function (collision) {
if ( TRACE ) { TRACE( "BodyPiece#OnCollisionEnter2D", this ); }
                ...
                var monster = { };
                collision.transform.parent.gameObject.TryGetComponent$1(MonsterController, monster);
                if (!UnityEngine.Object.op_Implicit(monster.v) || monster.v.IsDead) {
                    return;
                }
                this.player.Zombie();
            },
            /*BodyPiece.OnCollisionEnter2D end.*/
    ...
    /*BodyRenderer start.*/
    Bridge.define("BodyRenderer", {
        $kind: 4,
        statics: {
            methods: {
                getDefaultValue: function () {
if ( TRACE ) { TRACE( "BodyRenderer#getDefaultValue", this ); }
 return new BodyRenderer(); }
        ...
        ctors: {
            ctor: function () {
if ( TRACE ) { TRACE( "BodyRenderer#ctor", this ); }
...
if ( TRACE ) { TRACE( "BodyRenderer#getHashCode", this ); }

                var h = Bridge.addHash([5640832761, this.Renderer, this.ZSprite]);
                return h;
            },
            equals: function (o) {
if ( TRACE ) { TRACE( "BodyRenderer#equals", this ); }

                if (!Bridge.is(o, BodyRenderer)) {
                    return false;
                }
                return Bridge.equals(this.Renderer, o.Renderer) && Bridge.equals(this.ZSprite, o.ZSprite);
            },
            $clone: function (to) {
if ( TRACE ) { TRACE( "BodyRenderer#$clone", this ); }

                var s = to || new BodyRenderer();
                s.Renderer = this.Renderer;
                s.ZSprite = this.ZSprite;
                return s;
            }
        }
    });
...
if ( TRACE ) { TRACE( "BulletController#OnCollisionEnter2D", this ); }
                ...
                if (collision.gameObject.CompareTag("Monster")) {
                    ...
                    collision.transform.parent.gameObject.GetComponent(MonsterController).TakeDamage(this.damage);
                } else {
...
if ( TRACE ) { TRACE( "GameController#init", this ); }
                ...
                this.human = new Option();
                this.monster = new Option();
            }
        },
        methods: {
...
if ( TRACE ) { TRACE( "GameController#Awake", this ); }
                ...
                this.human.Button.onClick.AddListener(Bridge.fn.bind(this, function () {
                    this.ChooseOption(this.human.Controller);
                }));
                this.monster.Button.onClick.AddListener(Bridge.fn.bind(this, function () {
                    this.ChooseOption(this.monster.Controller);
                }));
            },
            /*GameController.Awake end.*/

            /*GameController.ChooseOption start.*/
            ChooseOption: function (option) {
if ( TRACE ) { TRACE( "GameController#ChooseOption", this ); }

                AudioController.Ins.PlaySFX(this.clickSound);
                this.optionController = option;
                this.optionController.InitMaxSpawn(this.maxSpawn);
                this.optionController.OnSpawn = Bridge.fn.combine(this.optionController.OnSpawn, Bridge.fn.cacheBind(this, this.Spawn));
                this.optionController.OnEmpty = Bridge.fn.combine(this.optionController.OnEmpty, Bridge.fn.cacheBind(this, this.Empty));
                this.optionController.OnEnd = Bridge.fn.combine(this.optionController.OnEnd, Bridge.fn.bind(this, function () {
                    this.StartCoroutine$1(this.WaitForEnd());
                }));
                this.optionController.gameObject.SetActive(true);
                this.startScene.gameObject.SetActive(false);
            },
            /*GameController.ChooseOption end.*/

            /*GameController.End start.*/
            End: function () {
if ( TRACE ) { TRACE( "GameController#End", this ); }

                if (this.isEnd) {
                    return;
                }
                this.isEnd = true;
                this.endScene.gameObject.SetActive(true);
            },
            /*GameController.End end.*/

            /*GameController.Spawn start.*/
            Spawn: function () {
if ( TRACE ) { TRACE( "GameController#Spawn", this ); }

                !Bridge.staticEquals(this.OnSpawn, null) ? this.OnSpawn() : null;
            },
            /*GameController.Spawn end.*/

            /*GameController.Empty start.*/
            Empty: function () {
if ( TRACE ) { TRACE( "GameController#Empty", this ); }

                !Bridge.staticEquals(this.OnEmpty, null) ? this.OnEmpty() : null;
            },
            /*GameController.Empty end.*/

            /*GameController.RemoveCharacter start.*/
            RemoveCharacter: function (isMonster) {
if ( TRACE ) { TRACE( "GameController#RemoveCharacter", this ); }

                if (isMonster) {
                    if (Bridge.is(this.optionController, MonsterOptionController)) {
                        this.optionController.RemoveCharacter();
                    }
                } else if (Bridge.is(this.optionController, HumanOptionController)) {
                    this.optionController.RemoveCharacter();
                }
            },
            /*GameController.RemoveCharacter end.*/
...
if ( TRACE ) { TRACE( "GameController#WaitForEnd", this ); }
    ...
    /*GroundCheck start.*/
    Bridge.define("GroundCheck", {
        inherits: [UnityEngine.MonoBehaviour],
        fields: {
            OnGround: false
        },
        methods: {
            /*GroundCheck.OnTriggerEnter2D start.*/
            OnTriggerEnter2D: function (collision) {
if ( TRACE ) { TRACE( "GroundCheck#OnTriggerEnter2D", this ); }

                this.OnGround = true;
            },
            /*GroundCheck.OnTriggerEnter2D end.*/

            /*GroundCheck.OnTriggerExit2D start.*/
            OnTriggerExit2D: function (collision) {
if ( TRACE ) { TRACE( "GroundCheck#OnTriggerExit2D", this ); }

                this.OnGround = false;
            },
            /*GroundCheck.OnTriggerExit2D end.*/
...
if ( TRACE ) { TRACE( "OptionController#Start", this ); }
            ...
            /*OptionController.InitMaxSpawn start.*/
            InitMaxSpawn: function (max) {
if ( TRACE ) { TRACE( "OptionController#InitMaxSpawn", this ); }

                this.maxSpawn = max;
                this.numText.text = Bridge.toString(this.maxSpawn);
            },
            /*OptionController.InitMaxSpawn end.*/

            /*OptionController.ClickAdd start.*/
            ClickAdd: function () {
if ( TRACE ) { TRACE( "OptionController#ClickAdd", this ); }

                if (UnityEngine.Object.op_Implicit(this.areaTut)) {
                    UnityEngine.MonoBehaviour.Destroy(this.areaTut);
                }
                this.AddCharacter(UnityEngine.Vector2.FromVector3(UnityEngine.Camera.main.ScreenToWorldPoint(UnityEngine.Input.mousePosition)), this.world);
            },
            /*OptionController.ClickAdd end.*/

            /*OptionController.AddCharacter start.*/
            AddCharacter: function (position, world) {
if ( TRACE ) { TRACE( "OptionController#AddCharacter", this ); }

                if (!UnityEngine.Object.op_Implicit(this.spawnPrefab) || this.maxSpawn <= 0 || this.onCD) {
                    return;
                }
                this.StartCoroutine$1(this.CD());
                this.maxSpawn = (this.maxSpawn - 1) | 0;
                this.numCharacter = (this.numCharacter + 1) | 0;
                this.numText.text = Bridge.toString(this.maxSpawn);
                !Bridge.staticEquals(this.OnSpawn, null) ? this.OnSpawn() : null;
                var m = UnityEngine.Object.Instantiate(UnityEngine.GameObject, this.spawnPrefab, world);
                m.transform.position = UnityEngine.Vector3.FromVector2(position.$clone());
                m.SetActive(true);
            },
            /*OptionController.AddCharacter end.*/

            /*OptionController.CD start.*/
            CD: function () {
if ( TRACE ) { TRACE( "OptionController#CD", this ); }
            ...
            /*OptionController.CD end.*/

            /*OptionController.RemoveCharacter start.*/
            RemoveCharacter: function () {
if ( TRACE ) { TRACE( "OptionController#RemoveCharacter", this ); }

                this.numCharacter = UnityEngine.Mathf.Max(0, ((this.numCharacter - 1) | 0));
                if (this.numCharacter <= 0) {
                    !Bridge.staticEquals(this.OnEmpty, null) ? this.OnEmpty() : null;
                    if (this.maxSpawn <= 0) {
            ...
            /*OptionController.RemoveCharacter end.*/
...
if ( TRACE ) { TRACE( "LayoutController#Fit", this ); }
                ...
                if (ratio > 1.0) {
                    ...
                    this.UI.transform.localScale = new pc.Vec3( 1, 1, 1 ).clone().scale( 1.5 );
                } else {
                    this.main.transform.localScale = new pc.Vec3( 1, 1, 1 );
                    this.UI.transform.localScale = new pc.Vec3( 1, 1, 1 );
                }
            },
...
if ( TRACE ) { TRACE( "LunaController#init", this ); }
                ...
                this.HeaderColor = new UnityEngine.Color();
            }
        },
        methods: {
...
if ( TRACE ) { TRACE( "LunaController#Start", this ); }
                ...
                this.headerText.color = this.HeaderColor.$clone();
                ...
                GameController.Ins.maxSpawn = this.MaxCountPlay;
                if (this.OneClick) {
                    this.clickCard.SetActive(true);
                }
            },
...
if ( TRACE ) { TRACE( "MonsterController#Move", this ); }
                ...
                if (!this.groundCheck.OnGround || this.isDead || !UnityEngine.Object.op_Implicit(this.trigger.Player)) {
                    this.StopAttack();
                    this.body.linearVelocity = new pc.Vec2( 0, this.body.linearVelocity.y );
                    return;
                }
                this.StartAttack();
                var direction = UnityEngine.Vector2.FromVector3(this.trigger.Player.Body.position.$clone().sub( this.body.transform.position ));
                if (Math.abs(direction.x) < 1.0) {
                    this.body.linearVelocity = new pc.Vec2( 0, 1 );
                    return;
                }
                var x = direction.clone().normalize().x < 0 ? -1 : 1;
                if (this.timer <= 0) {
                    this.timer = 1;
                    this.transform.localScale = new pc.Vec3( x, 1, 1 );
                }

                this.body.linearVelocity = new pc.Vec2( x * this.speed, 1 );
            },
...
if ( TRACE ) { TRACE( "MonsterController#Dead", this ); }
                ...
                GameController.Ins.RemoveCharacter(true);
...
if ( TRACE ) { TRACE( "MonsterController#Destroy$1", this ); }
            ...
            /*MonsterController.StartAttack start.*/
            StartAttack: function () {
if ( TRACE ) { TRACE( "MonsterController#StartAttack", this ); }

                if (this.attack != null) {
                    return;
                }
                this.attack = this.StartCoroutine$1(this.Animation());
            },
            /*MonsterController.StartAttack end.*/

            /*MonsterController.StopAttack start.*/
            StopAttack: function () {
if ( TRACE ) { TRACE( "MonsterController#StopAttack", this ); }

                if (this.attack == null) {
                    return;
                }
                this.StopCoroutine$2(this.attack);
                this.attack = null;
                this.leftHand.useMotor = false;
                this.rightHand.useMotor = false;
                this.leftLeg.useMotor = false;
            ...
            /*MonsterController.StopAttack end.*/
    ...
    /*MonsterTrigger start.*/
    Bridge.define("MonsterTrigger", {
        inherits: [UnityEngine.MonoBehaviour],
        fields: {
            player: null
        },
        props: {
            Player: {
                get: function () {
if ( TRACE ) { TRACE( "MonsterTrigger#Player#get", this ); }
        ...
        methods: {
            /*MonsterTrigger.OnTriggerStay2D start.*/
            OnTriggerStay2D: function (collision) {
if ( TRACE ) { TRACE( "MonsterTrigger#OnTriggerStay2D", this ); }

                if (UnityEngine.Object.op_Implicit(this.player) && !this.player.IsZombie) {
                    return;
                }
                var p = { };
                collision.transform.parent.TryGetComponent$1(PlayerController, p);
                if (!UnityEngine.Object.op_Implicit(p.v) || p.v.IsZombie) {
                    this.player = null;
                    return;
                }
            ...
            /*MonsterTrigger.OnTriggerStay2D end.*/

            /*MonsterTrigger.OnTriggerExit2D start.*/
            OnTriggerExit2D: function (collision) {
if ( TRACE ) { TRACE( "MonsterTrigger#OnTriggerExit2D", this ); }

                if (!UnityEngine.Object.op_Implicit(this.player)) {
                    return;
                }
                if (UnityEngine.GameObject.op_Equality(collision.transform.parent.gameObject, this.player.gameObject)) {
                    this.player = null;
                }
            },
            /*MonsterTrigger.OnTriggerExit2D end.*/
...
if ( TRACE ) { TRACE( "Option#getHashCode", this ); }
                ...
                var h = Bridge.addHash([1769266878, this.Button, this.Controller]);
                return h;
            },
            equals: function (o) {
if ( TRACE ) { TRACE( "Option#equals", this ); }
                ...
                return Bridge.equals(this.Button, o.Button) && Bridge.equals(this.Controller, o.Controller);
            },
            $clone: function (to) {
...
if ( TRACE ) { TRACE( "PlayerAttack#Start", this ); }
                ...
                this.player.OnDead = Bridge.fn.combine(this.player.OnDead, Bridge.fn.cacheBind(this, this.DropGun));
            },
...
if ( TRACE ) { TRACE( "PlayerAttack#Update", this ); }
            ...
            /*PlayerAttack.Shoot start.*/
            Shoot: function () {
if ( TRACE ) { TRACE( "PlayerAttack#Shoot", this ); }

                if (this.dropGun || this.onCD) {
                    return;
                }
                if (!UnityEngine.Object.op_Implicit(this.playerTrigger.Monster)) {
                    this.StopShoot();
                    return;
                }
            ...
            /*PlayerAttack.Shoot end.*/

            /*PlayerAttack.DropGun start.*/
            DropGun: function () {
if ( TRACE ) { TRACE( "PlayerAttack#DropGun", this ); }

                this.dropGun = true;
                this.gun.transform.parent.gameObject.AddComponent(UnityEngine.Rigidbody2D);
                this.StopShoot();
            },
            /*PlayerAttack.DropGun end.*/

            /*PlayerAttack.Animation start.*/
            Animation: function () {
if ( TRACE ) { TRACE( "PlayerAttack#Animation", this ); }
            ...
            /*PlayerAttack.Animation end.*/

            /*PlayerAttack.WaitForCD start.*/
            WaitForCD: function () {
if ( TRACE ) { TRACE( "PlayerAttack#WaitForCD", this ); }
            ...
            /*PlayerAttack.WaitForCD end.*/

            /*PlayerAttack.SpawnBullet start.*/
            SpawnBullet: function () {
if ( TRACE ) { TRACE( "PlayerAttack#SpawnBullet", this ); }

                PoolController.Ins.SpawnObj(this.bulletPrefab, UnityEngine.Vector2.FromVector3(this.gun.position), this.gun.rotation);
                AudioController.Ins.PlaySFX(this.shootSound);
                this.StartCoroutine$1(this.WaitForCD());
            },
            /*PlayerAttack.SpawnBullet end.*/

            /*PlayerAttack.StopShoot start.*/
            StopShoot: function () {
if ( TRACE ) { TRACE( "PlayerAttack#StopShoot", this ); }
    ...
    Bridge.define("PlayerController", {
        ...
        props: {
            Body: {
                get: function () {
if ( TRACE ) { TRACE( "PlayerController#Body#get", this ); }
        ...
        methods: {
            /*PlayerController.Zombie start.*/
            Zombie: function () {
if ( TRACE ) { TRACE( "PlayerController#Zombie", this ); }

                if (this.IsZombie) {
                    return;
                }
                this.IsZombie = true;
                AudioController.Ins.PlaySFX(this.biteSound);
                this.StartCoroutine$1(this.Dead());
            },
            /*PlayerController.Zombie end.*/
...
if ( TRACE ) { TRACE( "PlayerController#Dead", this ); }
                    ...
                    try {
                        for (;;) {
                            switch ($step) {
                                ...
                                case 1: {
                                    !Bridge.staticEquals(this.OnDead, null) ? this.OnDead() : null;
                                        $t = Bridge.getEnumerator(this.bodyRenderers);
                                        try {
                                            while ($t.moveNext()) {
                                                r = $t.Current.$clone();
                                                r.Renderer.sprite = r.ZSprite;
                                                r.Renderer.gameObject.layer = UnityEngine.LayerMask.NameToLayer("Monster");
                                            }
                                        } finally {
                                            if (Bridge.is($t, System.IDisposable)) {
                                                $t.System$IDisposable$Dispose();
                                        ...
                                        AudioController.Ins.PlaySFX(this.zombieSound);
                                        GameController.Ins.RemoveCharacter(false);
    ...
    Bridge.define("PlayerTrigger", {
        ...
        props: {
            Monster: {
                get: function () {
if ( TRACE ) { TRACE( "PlayerTrigger#Monster#get", this ); }
        ...
        methods: {
            /*PlayerTrigger.OnTriggerStay2D start.*/
            OnTriggerStay2D: function (collision) {
if ( TRACE ) { TRACE( "PlayerTrigger#OnTriggerStay2D", this ); }

                if (UnityEngine.Object.op_Implicit(this.monster) && !this.monster.IsDead) {
                    return;
                }
                var m = { };
                collision.transform.parent.TryGetComponent$1(MonsterController, m);
                if (!UnityEngine.Object.op_Implicit(m.v) || m.v.IsDead) {
                    this.monster = null;
                    return;
                }
            ...
            /*PlayerTrigger.OnTriggerStay2D end.*/

            /*PlayerTrigger.OnTriggerExit2D start.*/
            OnTriggerExit2D: function (collision) {
if ( TRACE ) { TRACE( "PlayerTrigger#OnTriggerExit2D", this ); }

                if (!UnityEngine.Object.op_Implicit(this.monster)) {
                    return;
                }
                if (UnityEngine.GameObject.op_Equality(collision.transform.parent.gameObject, this.monster.gameObject)) {
                    this.monster = null;
                }
            },
            /*PlayerTrigger.OnTriggerExit2D end.*/
...
if ( TRACE ) { TRACE( "PoolController#CreateNewObject", this ); }
                ...
                var obj = UnityEngine.Object.Instantiate(UnityEngine.GameObject, prefab, this.poolParent);
                return obj;
            },
...
if ( TRACE ) { TRACE( "PoolController#GetFreeObject", this ); }
                ...
                return this.CreateNewObject(prefab);
            },
            /*PoolController.GetFreeObject end.*/

            /*PoolController.SpawnObj start.*/
            SpawnObj: function (prefab, position, rotation) {
if ( TRACE ) { TRACE( "PoolController#SpawnObj", this ); }

                var obj = this.GetFreeObject(prefab);
                obj.transform.SetPositionAndRotation(UnityEngine.Vector3.FromVector2(position), rotation);
                obj.SetActive(true);
            },
            /*PoolController.SpawnObj end.*/
...
if ( TRACE ) { TRACE( "PoolController#ReturnToPool", this ); }
    ...
    /*HumanOptionController start.*/
    Bridge.define("HumanOptionController", {
        inherits: [OptionController]
    });
    /*HumanOptionController end.*/

    /*MonsterOptionController start.*/
    Bridge.define("MonsterOptionController", {
        inherits: [OptionController]
    });
    /*MonsterOptionController end.*/
    ...
    /*MonsterOptionController start.*/
    $m("MonsterOptionController", function () { return {"att":1048577,"a":2,"m":[{"a":2,"isSynthetic":true,"n":".ctor","t":1,"sn":"ctor"}]}; }, $n);
    /*MonsterOptionController end.*/

    /*MonsterTrigger start.*/
    $m("MonsterTrigger", function () { return {"att":1048577,"a":2,"m":[{"a":2,"isSynthetic":true,"n":".ctor","t":1,"sn":"ctor"},{"a":1,"n":"OnTriggerExit2D","t":8,"pi":[{"n":"collision","pt":$n[1].Collider2D,"ps":0}],"sn":"OnTriggerExit2D","rt":$n[0].Void,"p":[$n[1].Collider2D]},{"a":1,"n":"OnTriggerStay2D","t":8,"pi":[{"n":"collision","pt":$n[1].Collider2D,"ps":0}],"sn":"OnTriggerStay2D","rt":$n[0].Void,"p":[$n[1].Collider2D]},{"a":2,"n":"Player","t":16,"rt":PlayerController,"g":{"a":2,"n":"get_Player","t":8,"rt":PlayerController,"fg":"Player"},"fn":"Player"},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"player","t":4,"rt":PlayerController,"sn":"player"}]}; }, $n);
    /*MonsterTrigger end.*/

    /*OptionController start.*/
    $m("OptionController", function () { return {"att":1048705,"a":2,"m":[{"a":3,"isSynthetic":true,"n":".ctor","t":1,"sn":"ctor"},{"a":2,"n":"AddCharacter","t":8,"pi":[{"n":"position","pt":$n[1].Vector2,"ps":0},{"n":"world","pt":$n[1].Transform,"ps":1}],"sn":"AddCharacter","rt":$n[0].Void,"p":[$n[1].Vector2,$n[1].Transform]},{"a":1,"n":"CD","t":8,"sn":"CD","rt":$n[2].IEnumerator},{"a":1,"n":"ClickAdd","t":8,"sn":"ClickAdd","rt":$n[0].Void},{"a":2,"n":"InitMaxSpawn","t":8,"pi":[{"n":"max","pt":$n[0].Int32,"ps":0}],"sn":"InitMaxSpawn","rt":$n[0].Void,"p":[$n[0].Int32]},{"a":2,"n":"RemoveCharacter","t":8,"sn":"RemoveCharacter","rt":$n[0].Void},{"a":1,"n":"Start","t":8,"sn":"Start","rt":$n[0].Void},{"a":2,"n":"OnEmpty","t":4,"rt":Function,"sn":"OnEmpty"},{"a":2,"n":"OnEnd","t":4,"rt":Function,"sn":"OnEnd"},{"a":2,"n":"OnSpawn","t":4,"rt":Function,"sn":"OnSpawn"},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"area","t":4,"rt":$n[4].Button,"sn":"area"},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"areaTut","t":4,"rt":$n[1].GameObject,"sn":"areaTut"},{"a":3,"n":"maxSpawn","t":4,"rt":$n[0].Int32,"sn":"maxSpawn","box":function ($v) { return Bridge.box($v, System.Int32);}},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":3,"n":"numCharacter","t":4,"rt":$n[0].Int32,"sn":"numCharacter","box":function ($v) { return Bridge.box($v, System.Int32);}},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":3,"n":"numText","t":4,"rt":$n[4].Text,"sn":"numText"},{"a":1,"n":"onCD","t":4,"rt":$n[0].Boolean,"sn":"onCD","box":function ($v) { return Bridge.box($v, System.Boolean, System.Boolean.toString);}},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":3,"n":"spawnPrefab","t":4,"rt":$n[1].GameObject,"sn":"spawnPrefab"},{"at":[new UnityEngine.HeaderAttribute("Spawn"),new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"world","t":4,"rt":$n[1].Transform,"sn":"world"}]}; }, $n);
    /*OptionController end.*/

    /*PlayerAttack start.*/
    $m("PlayerAttack", function () { return {"att":1048577,"a":2,"m":[{"a":2,"isSynthetic":true,"n":".ctor","t":1,"sn":"ctor"},{"a":1,"n":"Animation","t":8,"sn":"Animation","rt":$n[2].IEnumerator},{"a":1,"n":"DropGun","t":8,"sn":"DropGun","rt":$n[0].Void},{"a":1,"n":"Shoot","t":8,"sn":"Shoot","rt":$n[0].Void},{"a":1,"n":"SpawnBullet","t":8,"sn":"SpawnBullet","rt":$n[0].Void},{"a":1,"n":"Start","t":8,"sn":"Start","rt":$n[0].Void},{"a":2,"n":"StopShoot","t":8,"sn":"StopShoot","rt":$n[0].Void},{"a":1,"n":"Update","t":8,"sn":"Update","rt":$n[0].Void},{"a":1,"n":"WaitForCD","t":8,"sn":"WaitForCD","rt":$n[2].IEnumerator},{"at":[new UnityEngine.LunaPlaygroundFieldAttribute("Shoot CD", -1, null, false, null)],"a":2,"n":"ShootCD","t":4,"rt":$n[0].Single,"sn":"ShootCD","box":function ($v) { return Bridge.box($v, System.Single, System.Single.format, System.Single.getHashCode);}},{"a":1,"n":"animationCoroutine","t":4,"rt":$n[1].Coroutine,"sn":"animationCoroutine"},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"bulletPrefab","t":4,"rt":$n[1].GameObject,"sn":"bulletPrefab"},{"a":1,"n":"dropGun","t":4,"rt":$n[0].Boolean,"sn":"dropGun","box":function ($v) { return Bridge.box($v, System.Boolean, System.Boolean.toString);}},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"gun","t":4,"rt":$n[1].Transform,"sn":"gun"},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"left","t":4,"rt":$n[1].HingeJoint2D,"sn":"left"},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"onCD","t":4,"rt":$n[0].Boolean,"sn":"onCD","box":function ($v) { return Bridge.box($v, System.Boolean, System.Boolean.toString);}},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"player","t":4,"rt":PlayerController,"sn":"player"},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"playerTrigger","t":4,"rt":PlayerTrigger,"sn":"playerTrigger"},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"right","t":4,"rt":$n[1].HingeJoint2D,"sn":"right"},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"shootSound","t":4,"rt":$n[1].AudioClip,"sn":"shootSound"},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"timeMotor","t":4,"rt":$n[0].Single,"sn":"timeMotor","box":function ($v) { return Bridge.box($v, System.Single, System.Single.format, System.Single.getHashCode);}}]}; }, $n);
    /*PlayerAttack end.*/

    /*PlayerController start.*/
    $m("PlayerController", function () { return {"att":1048577,"a":2,"m":[{"a":2,"isSynthetic":true,"n":".ctor","t":1,"sn":"ctor"},{"a":1,"n":"Dead","t":8,"sn":"Dead","rt":$n[2].IEnumerator},{"a":2,"n":"Zombie","t":8,"sn":"Zombie","rt":$n[0].Void},{"a":2,"n":"Body","t":16,"rt":$n[1].Transform,"g":{"a":2,"n":"get_Body","t":8,"rt":$n[1].Transform,"fg":"Body"},"fn":"Body"},{"a":2,"n":"IsZombie","t":4,"rt":$n[0].Boolean,"sn":"IsZombie","box":function ($v) { return Bridge.box($v, System.Boolean, System.Boolean.toString);}},{"a":2,"n":"OnDead","t":4,"rt":Function,"sn":"OnDead"},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"biteSound","t":4,"rt":$n[1].AudioClip,"sn":"biteSound"},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"body","t":4,"rt":$n[1].Transform,"sn":"body"},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"bodyRenderers","t":4,"rt":$n[3].List$1(BodyRenderer),"sn":"bodyRenderers"},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"zombieSound","t":4,"rt":$n[1].AudioClip,"sn":"zombieSound"}]}; }, $n);
    /*PlayerController end.*/

    /*BodyRenderer start.*/
    $m("BodyRenderer", function () { return {"att":1057033,"a":2,"at":[new System.SerializableAttribute()],"m":[{"a":2,"isSynthetic":true,"n":".ctor","t":1,"sn":"ctor"},{"a":2,"n":"Renderer","t":4,"rt":$n[1].SpriteRenderer,"sn":"Renderer"},{"a":2,"n":"ZSprite","t":4,"rt":$n[1].Sprite,"sn":"ZSprite"}]}; }, $n);
    /*BodyRenderer end.*/

    /*BodyPiece start.*/
    $m("BodyPiece", function () { return {"att":1048577,"a":2,"m":[{"a":2,"isSynthetic":true,"n":".ctor","t":1,"sn":"ctor"},{"a":1,"n":"OnCollisionEnter2D","t":8,"pi":[{"n":"collision","pt":$n[1].Collision2D,"ps":0}],"sn":"OnCollisionEnter2D","rt":$n[0].Void,"p":[$n[1].Collision2D]},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"player","t":4,"rt":PlayerController,"sn":"player"}]}; }, $n);
    /*BodyPiece end.*/

    /*PlayerTrigger start.*/
    $m("PlayerTrigger", function () { return {"att":1048577,"a":2,"m":[{"a":2,"isSynthetic":true,"n":".ctor","t":1,"sn":"ctor"},{"a":1,"n":"OnTriggerExit2D","t":8,"pi":[{"n":"collision","pt":$n[1].Collider2D,"ps":0}],"sn":"OnTriggerExit2D","rt":$n[0].Void,"p":[$n[1].Collider2D]},{"a":1,"n":"OnTriggerStay2D","t":8,"pi":[{"n":"collision","pt":$n[1].Collider2D,"ps":0}],"sn":"OnTriggerStay2D","rt":$n[0].Void,"p":[$n[1].Collider2D]},{"a":2,"n":"Monster","t":16,"rt":MonsterController,"g":{"a":2,"n":"get_Monster","t":8,"rt":MonsterController,"fg":"Monster"},"fn":"Monster"},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"monster","t":4,"rt":MonsterController,"sn":"monster"}]}; }, $n);
    /*PlayerTrigger end.*/
