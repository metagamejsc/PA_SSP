...
Deserializers["GameController"] = function (request, data, root) {
  ...
  var i721 = data
  i720.OnPause = request.d('System.Action', i721[0], i720.OnPause)
  i720.OnResume = request.d('System.Action', i721[1], i720.OnResume)
  i720.OnGameOver = request.d('System.Action', i721[2], i720.OnGameOver)
  i720.OnGameComplete = request.d('System.Action', i721[3], i720.OnGameComplete)
  request.r(i721[4], i721[5], 0, i720, 'startScene')
  request.r(i721[6], i721[7], 0, i720, 'header')
  request.r(i721[8], i721[9], 0, i720, 'clickSound')
  request.r(i721[10], i721[11], 0, i720, 'options')
  request.r(i721[12], i721[13], 0, i720, 'smokeButton')
  request.r(i721[14], i721[15], 0, i720, 'smoke')
  request.r(i721[16], i721[17], 0, i720, 'landmindButton')
  request.r(i721[18], i721[19], 0, i720, 'landmind')
  request.r(i721[20], i721[21], 0, i720, 'gunButton')
  request.r(i721[22], i721[23], 0, i720, 'tut')
  request.r(i721[24], i721[25], 0, i720, 'endScene')
  request.r(i721[26], i721[27], 0, i720, 'completeScene')
  request.r(i721[28], i721[29], 0, i720, 'gameOverScene')
  request.r(i721[30], i721[31], 0, i720, 'player')
  i720.numMonster = i721[32]
  request.r(i721[33], i721[34], 0, i720, 'world')
  return i720
}
...
Deserializers.buildID = "de4042c4-8be0-4f4d-9dd5-20d798a048cf";
