...
public class FightController : MonoBehaviour
{
    ...
    public virtual void Action([Bridge.Ref] Vector2 position, [Bridge.Ref] Quaternion rotation)
    {
        Spawn(position, rotation);
    }

    protected virtual void Spawn([Bridge.Ref] Vector2 position, [Bridge.Ref] Quaternion rotation)
    {
