...
if ( TRACE ) { TRACE( "LunaController#init", this ); }
                ...
                this.TutTextColor = new UnityEngine.Color();
            }
        },
        methods: {
...
if ( TRACE ) { TRACE( "LunaController#Start", this ); }
                ...
                this.text.text = this.TutText;
                this.text.color = this.TutTextColor.$clone();
