...
if ( TRACE ) { TRACE( "GameController#InitMonster", this ); }
                ...
                if (this.monsters == null || this.monsters.Count === 0) {
                    return;
                }
                if (this.TypeMonster < 0) {
                    this.TypeMonster = 0;
                }
                if (this.TypeMonster >= this.monsters.Count) {
                    this.TypeMonster = (this.monsters.Count - 1) | 0;
                }
                this.currentMonster = this.monsters.getItem(this.TypeMonster).$clone();
                this.currentMonster.Button.gameObject.SetActive(true);
            },
...
if ( TRACE ) { TRACE( "Monster#getHashCode", this ); }
                ...
                var h = Bridge.addHash([1944114369, this.Button, this.Prefab]);
                return h;
            },
            equals: function (o) {
if ( TRACE ) { TRACE( "Monster#equals", this ); }
                ...
                return Bridge.equals(this.Button, o.Button) && Bridge.equals(this.Prefab, o.Prefab);
            },
            $clone: function (to) {
